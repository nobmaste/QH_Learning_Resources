...
// 调试工具: 凌智STM32H750核心板、OLED液晶屏、LZE_ST_LINK2
// 说　　明: 
//				(1) 调试使用的系统时钟频率Fsysclk=400MHz;
//     		(2) AD9854的数据传输方式:串行传输方式;
//				(3) AD9854_IO与凌智STM32H750核心板连接方式如下:
//-----------------------------------------------------------------
//               IO 连接说明
//-----------------------------------------------------------------
//					 AD9854模块标号     |    STM32核心板   
...
//					 OSK      					外部控制信号接在OSK引脚来控制 GPIOC_PIN13
       ...
       case  2 :	{
  	   ...
  	   case  6 :	{
				            ...
				            OLED_ShowString(10,4,"   A M   ",16);
										am_test (80,100);		  				            			 //am_test(调制波频率，调制度设置)				
