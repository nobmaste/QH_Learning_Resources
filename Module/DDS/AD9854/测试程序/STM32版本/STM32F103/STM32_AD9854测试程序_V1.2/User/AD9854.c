...
void Sweep_out (void)
{
	...
	for(i=0;i<58;i++)
	{
	  	...
	  	Delay_1ms(250);                   
		if (F < 1000)								      	// Êä³öÆµÂÊÐ¡ÓÚ1kHz
					{
						F += 199;
					}
					else if (F< 10000)						// Êä³öÆµÂÊÐ¡ÓÚ10kHz
					{
						F += 2000;
					}
					else if (F < 100000)					// Êä³öÆµÂÊÐ¡ÓÚ100kHz
					{
						F += 20000;
					}
					else if (F < 1000000)					// Êä³öÆµÂÊÐ¡ÓÚ1MHz
					{
						F += 200000;
					}
					else if (F < 10000000)				// Êä³öÆµÂÊÐ¡ÓÚ10MHz
					{
						F += 2000000;
					}
					else 
					{
						F += 5000000;								// Êä³öÆµÂÊÐ¡ÓÚ140MHz
					}
