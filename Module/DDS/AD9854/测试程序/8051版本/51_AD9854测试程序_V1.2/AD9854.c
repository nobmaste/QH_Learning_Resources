...
{
	AD9854_AdrBus  = (addr&0x3f) | (P0&0xc0);
	AD9854_DataBus = dat;
	AD9854_WR      = 0;
	AD9854_WR      = 1;	
}
...
//====================================================================================
//函数名称:void AD9854_SetChirp(ulong Freq_Low,ulong Freq_Up_Down,ulong FreRate)
//函数功能:AD9854的Chirp设置
//入口参数:Freq_Low          RFSK低频率	   48Bit
//         Freq_Up_Down		 步进频率	   48Bit
//		   FreRate           斜率时钟控制  20Bit
...
//         频率 上升或者下降 一个步进频率
//====================================================================================
void AD9854_SetChirp(ulong Freq_Low,ulong Freq_Up_Down,ulong FreRate)
{
	uchar count=6;
	uchar Adress1,Adress2,Adress3;
  const uint  Shape=4000;			   //幅度设置. 为12 Bit,取值范围为(0~4095)
